...
module.exports.routes = {
  ...
  '/delivery/:delivery_id/manage' : 'DeliveryController.manage',
  '/delivery/:delivery_id/add/:car_id' : 'DeliveryController.addCar',
  '/delivery/:delivery_id/remove/:car_id' : 'DeliveryController.removeCar',

  // '/delivery' : 'DeliveryController.getCarsAtStation',
  // '/delivery/add/:car_id' : 'DeliveryController.addCar',
  // '/cars/:id' : 'CarsController.ajaxLookup',
